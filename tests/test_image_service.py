...
def test_rgb_image_is_valid(service):
    ...
    result = service._validate_rgb(image)
...
def test_prepare_scale_is_positive(
    service,
):
    image = make_image(
        1600,
...
def test_tile_positions_are_sorted(
    service,
):
    positions = service._tile_positions(
        5000,
...
def test_iter_tiles_small_image(
    service,
):
    image = make_image(
        800,
...
def test_iter_tiles_large_image(
    service,
):
    image = make_image(
        3000,
...
def test_tiles_cover_left_edge(
    service,
):
    image = make_image(
        3000,
...
def test_tiles_cover_right_edge(
    service,
):
    width = 3000
...
def test_tiles_cover_bottom_edge(
    service,
):
    height = 2500
...
def test_tile_preserves_rgb_channels(
    service,
):
    image = np.zeros(
        (1500, 1500, 3),
